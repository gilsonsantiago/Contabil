{
 Unidade com funcao para converter numeros (double) em seu correspondente
 extenso. Para utilizá-la, chame a funcao Extenso com o numero a ser convertido
 como parametro, e o resultado será uma string com o valor correspondente por
 extenso.

 Serão analisados 12 digitos antes do ponto decimal e duas casas
 decimais.

 A nome da moeda usada pode ser facilmente alterada, bastando alterar o
 valor das constantes MoedaSingular, MoedaPlural, CentSingular e CentPlural.

 Esta unidade pode ser livremente usada, aterada e distribuída desde que sejam
 mantidos os dados do autor original:

 Milton Terre
 PRIORI Informática Ltda.
 priorinf@certto.com.br
}
...
Function escrito(Valor: double):string;
